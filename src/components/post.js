...
const Post = ({ post, relatedPost, type }) => {
  ...
  useEffect(() => {
    ...
    setModifiedHtml(DOMPurify.sanitize(doc.body.innerHTML)) // Sanitize the HTML content
  }, [post.html])
            ...
            <div className={`${bioStyles.bio} ${headStyles.description}`}>
              ...
              <p
                ...
                dangerouslySetInnerHTML={{
                  __html: DOMPurify.sanitize(post.frontmatter.description || post.excerpt), // Sanitize the HTML content
                }}
              />
            </div>
              ...
              <div className={`${styles.author} d-flex py-96`}>
                ...
                <div className={styles.aboutAuthor}>
                  <div className={styles.aboutAuthorInner}>
                    ...
                    <p dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(author.bio) }}></p> {/* Sanitize the HTML content */}
                  </div>
                </div>
              </div>
