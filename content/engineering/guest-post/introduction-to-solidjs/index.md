...
Solid provides special components called `<Show>` to render a template based on a conditioner the value of a signal. [Here's an example of that](https://playground.solidjs.com/?hash=1279589651&version=1.4.1):
