...
There are different types of multi factor authentication checks you can use to implement MFA— and the list is always growing. We have picked the common ones here: 
