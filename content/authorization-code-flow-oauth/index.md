...
7. The Client-Server receives and processes the ID token and access token. The access token is then kept in the Client-Server, which can make requests to resources on behalf of the User Client without exposing the token itself.
